...
type IDC struct {
	...
	// 供应商信息
	Vendor string `gorm:"column:vendor;type:varchar(50)" json:"vendor" validate:"required"`
	Telephone string `gorm:"column:telephone;type:varchar(50)" json:"telephone" validate:"required"`
	Contact string `gorm:"column:contact;type:varchar(50)" json:"contact" validate:"required"`
